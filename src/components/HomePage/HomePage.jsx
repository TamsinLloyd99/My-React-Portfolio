        ...
        <section className="skills">
          ...
          <ul>
            ...
            <li>
              ...
              <p>A keen eye for design principles,
              with a focus on creating visually appealing and user-friendly
              interfaces. Skilled in translating design mockups into
              pixel-perfect, functional web elements.</p>
            </li>
            <li>
              <strong> Web Technologies:</strong>
              <p>Familiar with various web technologies, including RESTful APIs,
            ...
            <li>
              ...
              <p>Proficient in using version control systems like Git to manage and
              track changes in code repositories, ensuring collaboration and
              codebase integrity.</p>
            </li>
            <li>
              <strong>Responsive Design:</strong>
              <p>Experienced in implementing responsive design principles to ensure
              optimal viewing experiences across a variety of devices and screen
              sizes.</p>
            </li>
          </ul>
          <br></br>
          ...
          <ul>
            <li>
             ...
             <p>Adept at identifying and solving complex problems with a logical
              and analytical approach. Enjoys tackling challenges and finding
              innovative solutions.</p> 
            </li>
            <li>
              <strong>Collaboration:</strong>
             <p>Strong team player with excellent communication skills.
              Comfortable collaborating with cross-functional teams to achieve
              project goals.</p> 
            </li>
            <li>
              <strong>Adaptability:</strong>
              <p>Quick learner with a flexible mindset, able to adapt to evolving
              technologies and industry trends. Open to exploring new tools and
              frameworks to enhance skillset.</p>
            </li>
            <li>
              <strong> Attention to Detail:</strong>
             <p>Meticulous in writing clean, maintainable code and ensuring
              high-quality outputs. Pays attention to details to deliver
              polished and error-free applications.</p> 
            </li>
            <li>
              <strong>Continuous Learning:</strong>
              <p>Passionate about staying up-to-date with the latest advancements
